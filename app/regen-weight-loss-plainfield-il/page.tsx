...
const content = getRegenWeightLossCitySeo("plainfield");
...
export default function RegenWeightLossPlainfieldPage() {
  return <RegenWeightLossCityRoutePage slug="plainfield" />;
}
