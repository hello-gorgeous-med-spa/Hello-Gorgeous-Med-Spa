...
const content = getBrowMicrobladingCitySeo("yorkville");
...
export default function MicrobladingYorkvillePage() {
  return <BrowMicrobladingCityRoutePage slug="yorkville" />;
}
