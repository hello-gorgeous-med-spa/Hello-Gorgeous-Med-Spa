...
export default function AuroraHubPage() {
  const hubProfile = getCityHubProfile("aurora-il");
          ...
          <FadeUp>
            ...
            <p className="mt-6 text-xl text-black/80 max-w-3xl leading-relaxed">
              {hubProfile?.heroSubline ??
                "We serve Aurora clients with a consult-first, safety-driven approach—designed for confident, natural-looking outcomes."}
            </p>
            ...
            <CityHubLocalBlock hubSlug="aurora-il" />
          </FadeUp>
        </div>
      </Section>
