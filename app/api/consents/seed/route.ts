...
I have discussed this treatment with my provider and understand the risks and benefits.`,
  ...
  },
  {
    ...
    slug: 'morpheus8-consent',
    description: 'Morpheus8 RF microneedling (face & body) treatment consent',
    content: `INFORMED CONSENT FOR MORPHEUS8 RF MICRONEEDLING

I understand that I am receiving Morpheus8 treatment, which combines fractional radiofrequency (RF) energy with microneedling to improve skin texture, tone, laxity, and contour on the face and/or body.

HOW IT WORKS:
• Fine needles deliver RF energy into the skin at controlled depths
• Treatment stimulates collagen and elastin remodeling
• Multiple sessions may be recommended for optimal results

RISKS AND POSSIBLE SIDE EFFECTS:
• Redness, swelling, tenderness (typically 2–5 days)
• Pinpoint bleeding or scabbing (temporary)
• Bruising, dryness, or flaking
• Temporary hyperpigmentation or hypopigmentation (rare)
• Scarring (rare, with improper aftercare or infection)
• Infection (rare; follow aftercare instructions)
• Nerve injury (rare)

CONTRAINDICATIONS - I confirm that:
• I am NOT pregnant or breastfeeding
• I do NOT have active infection or open wounds in the treatment area
• I do NOT have a pacemaker or implanted electronic devices in the treatment area
• I have disclosed all medications and supplements (especially blood thinners)
• I have not used isotretinoin (Accutane) in the past 6 months (if applicable)

EXPECTATIONS:
• Results develop over 2–6 months as collagen remodels
• Multiple treatments (e.g., 2–3) may be recommended
• I will follow all pre and post-treatment instructions provided
...
I have read and understand this consent form and have had the opportunity to ask questions.`,
    ...
    requires_witness: false,
    version: 1,
    required_for_services: ['morpheus8', 'morpheus8-rf'],
  },
  {
    name: 'Quantum RF Skin Tightening Consent',
    slug: 'quantum-rf-consent',
    description: 'Quantum RF subdermal skin tightening treatment consent',
    content: `INFORMED CONSENT FOR QUANTUM RF SKIN TIGHTENING

I understand that I am receiving Quantum RF treatment, a minimally invasive procedure that uses subdermal radiofrequency energy to tighten loose skin on areas such as the chin/neck, abdomen, arms, buttocks, or other approved areas.

HOW IT WORKS:
• A small probe is inserted under the skin to deliver RF energy
• Treatment is performed under local anesthesia
• The procedure stimulates collagen contraction and remodeling
• Results develop over several months

RISKS AND POSSIBLE COMPLICATIONS:
• Swelling, bruising, tenderness (common; may last days to weeks)
• Temporary numbness or altered sensation
• Infection (rare; minimized with sterile technique and aftercare)
• Scarring (rare)
• Asymmetry or unsatisfactory results
• Need for additional or touch-up treatments
• Rare: nerve injury, skin necrosis, or thermal injury

PROCEDURE DETAILS:
• Local anesthesia will be used
• I will follow compression garment and aftercare instructions as provided
• I may need to avoid strenuous activity for a period as advised

CONTRAINDICATIONS - I confirm that:
• I am NOT pregnant or breastfeeding
• I do NOT have a pacemaker or implanted electronic devices in or near the treatment area
• I do NOT have active infection, open wounds, or uncontrolled medical conditions in the treatment area
• I have disclosed all medications and medical history
• I understand this is an elective cosmetic procedure

I have read and understand this consent form and have had the opportunity to ask questions.`,
    is_active: true,
    requires_witness: false,
    version: 1,
    required_for_services: ['quantum-rf'],
  },
  {
    name: 'Solaria CO₂ Laser Consent',
    slug: 'solaria-co2-laser-consent',
    description: 'Solaria fractional CO₂ laser treatment consent',
    content: `INFORMED CONSENT FOR SOLARIA CO₂ LASER TREATMENT

I understand that I am receiving fractional CO₂ laser treatment (Solaria or similar device) for skin resurfacing, which may be used to improve wrinkles, scars, stretch marks, texture, tone, and other conditions as discussed with my provider.

HOW IT WORKS:
• A laser creates controlled microscopic treatment zones in the skin
• The body heals these areas, producing new collagen and smoother skin
• Treatment may be ablative or fractional depending on settings and goals

RISKS AND POSSIBLE SIDE EFFECTS:
• Redness, swelling, oozing, crusting (typical for several days to 2 weeks)
• Itching, dryness, peeling
• Temporary or prolonged redness (weeks to months in some cases)
• Hyperpigmentation or hypopigmentation (possible, especially in darker skin)
• Scarring (rare but possible)
• Infection (rare; follow aftercare strictly)
• Flare of cold sores (herpes) if prone; antiviral may be recommended
• Eye injury if treatment is near eyes (eye protection will be used)

CONTRAINDICATIONS - I confirm that:
• I am NOT pregnant or breastfeeding
• I do NOT have active infection, open wounds, or cold sores in the treatment area
• I have disclosed use of isotretinoin (Accutane) and will wait as advised before treatment
• I have disclosed all medications and supplements
• I will avoid sun exposure and use sunscreen as directed before and after

EXPECTATIONS:
• Downtime and healing time vary by depth and area treated
• Multiple sessions may be recommended
• I will follow all pre and post-treatment instructions
• I consent to before/after photographs for my medical record
...
I have read and understand this consent form and have had the opportunity to ask questions.`,
    ...
    requires_witness: false,
    version: 1,
    required_for_services: ['solaria-co2', 'solaria', 'co2-laser', 'stretch-mark'],
  },
];
