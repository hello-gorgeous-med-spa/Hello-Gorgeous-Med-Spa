...
const PRIORITY_SERVICE_URLS = [
  ...
  "/rx/catalog",
  "/rx/catalog/goal/lose-weight",
  "/rx/catalog/goal/recovery-and-performance",
  "/rx/catalog/goal/hormones",
  "/rx/catalog/goal/intimacy",
  "/rx/catalog/goal/skin-and-hair",
  "/rx/catalog/goal/energy-and-longevity",
  "/peptides/bpc-157",
  "/peptides/sermorelin",
