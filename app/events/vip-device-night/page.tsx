  ...
  return (
    <>
      ...
      <main className="bg-white text-black min-h-screen">
        ...
        <section className="py-14 px-6 bg-zinc-950 text-white border-b border-white/10">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-center">Event launch video</h2>
            <p className="mt-3 text-center text-white/70 text-sm">
              Watch the Luxora InMode event launch preview and share it with friends who should RSVP.
            </p>
            <div className="mt-8 rounded-2xl overflow-hidden border border-white/10 bg-black shadow-xl">
              <video
                controls
                preload="metadata"
            ...
            <div className="mt-5 text-center">
              <a
                href="/videos/luxora-inmode-event-launch.mp4"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center rounded-full border border-white/30 text-white font-semibold px-6 py-2.5 hover:border-[#E6007E] transition-colors"
              >
