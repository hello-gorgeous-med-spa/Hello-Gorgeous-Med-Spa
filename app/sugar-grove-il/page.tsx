...
export const metadata: Metadata = pageMetadata({
  title: "Med Spa Near Sugar Grove, IL | Botox, Fillers, Weight Loss",
  description:
    "Hello Gorgeous Med Spa serves Sugar Grove, IL with luxury clinical aesthetics. Botox, dermal fillers, Semaglutide weight loss, hormone therapy, microneedling & more. Located in nearby Oswego.",
  path: "/sugar-grove-il",
});
...
function pageFaqs() {
  return [
    {
      question: "Do you serve clients from Sugar Grove, IL?",
      answer:
        "Yes! Hello Gorgeous Med Spa is located in Oswego, IL — conveniently close to Sugar Grove. We proudly serve clients from Sugar Grove and Kane County.",
    },
    {
...
export default function SugarGroveHubPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusinessJsonLd("Sugar Grove, IL")) }}
      />
      <script
        type="application/ld+json"
        ...
        <div className="relative z-10">
          <FadeUp>
            ...
            <p className="mt-6 text-xl text-black/80 max-w-3xl leading-relaxed">
              Hello Gorgeous Med Spa brings premium clinical aesthetics to Sugar Grove residents. 
      ...
      <Section>
        <FadeUp>
          ...
          <p className="mt-4 text-white/70 max-w-2xl">
            These are the most requested clinical and aesthetics services for our Sugar Grove patients.
          </p>
        </FadeUp>
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <FadeUp>
              <h2 className="text-3xl md:text-4xl font-bold text-white">
                Why Sugar Grove clients choose us
              </h2>
              <p className="mt-4 text-white/70 max-w-2xl">
                Just minutes from Sugar Grove, Hello Gorgeous offers the premium med spa experience 
            ...
            <div className="mt-10 grid gap-4">
              {[
                ...
                },
                {
                  ...
                  b: "Just a short drive from Sugar Grove to our Oswego clinic.",
                },
              ].map((x, idx) => (
      ...
      <Section>
        <FadeUp>
          ...
          <p className="mt-4 text-white/70 max-w-2xl">
            Common questions from Sugar Grove residents about our services.
          </p>
        </FadeUp>
