...
export function generateMetadata({ params }: { params: { service: string } }): Metadata {
  ...
  if (!s) {
    return pageMetadata({
      title: "Sugar Grove, IL Service",
      description: "Service details for Sugar Grove, IL.",
      path: "/sugar-grove-il",
    });
  }

  return pageMetadata({
    title: `${s.name} Near Sugar Grove, IL | Hello Gorgeous Med Spa`,
    description: `${s.name} for Sugar Grove, IL residents — ${s.short} Book a consultation at Hello Gorgeous Med Spa in Oswego.`,
    path: `/sugar-grove-il/${s.slug}`,
  });
}
...
function locationFaqs(serviceName: string) {
  return [
    {
      question: `Do you offer ${serviceName} for Sugar Grove clients?`,
      answer: "Yes—Hello Gorgeous Med Spa serves clients from Sugar Grove. Our clinic is located in nearby Oswego, IL.",
    },
    {
    ...
    },
    {
      ...
      answer: "Our clinic is located at 74 W. Washington St., Oswego, IL 60543 — conveniently close to Sugar Grove.",
    },
  ];
}

export default function SugarGroveServicePage({ params }: { params: { service: string } }) {
  ...
  const breadcrumbs = [
    ...
    { name: "Sugar Grove, IL", url: `${SITE.url}/sugar-grove-il` },
    { name: s.name, url: `${SITE.url}/sugar-grove-il/${s.slug}` },
  ];
  ...
  return (
    <>
        ...
        <div className="relative z-10">
          <FadeUp>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <CTA href="/sugar-grove-il" variant="outline">
                Back to Sugar Grove hub
              </CTA>
            </div>
          ...
          <div className="lg:col-span-7">
            <FadeUp>
              <h2 className="text-3xl md:text-4xl font-bold text-white">
                {s.name} for Sugar Grove residents
              </h2>
              <p className="mt-4 text-white/70 max-w-2xl">
                This page helps Sugar Grove clients understand next steps. For full details and FAQs,
            ...
            <div className="mt-10 grid gap-4">
              {[
                ...
                { t: "Serving Sugar Grove", b: "Convenient for Sugar Grove clients — just minutes to our Oswego location." },
              ].map((x, idx) => (
      ...
      <Section>
        <FadeUp>
          <h2 className="text-3xl md:text-4xl font-bold text-white">Sugar Grove FAQ</h2>
          <p className="mt-4 text-white/70 max-w-2xl">
            Quick answers for local patients searching for {s.name} near Sugar Grove, IL.
          </p>
        </FadeUp>
