...
const careGuides = [
  ...
  },
  {
    ...
    description: "Pre & post care for the deepest RF microneedling (8mm). InMode Trifecta.",
    viewOnline: "/pre-post-care/morpheus8-burst",
    serviceLink: "/morpheus8-burst-oswego-il",
    icon: "⚡",
  },
  {
    id: "solaria-co2",
    title: "Solaria CO₂ Laser",
    description: "Pre & post care for fractional CO₂ laser resurfacing. Includes antiviral guidance.",
    viewOnline: "/pre-post-care/solaria-co2",
    serviceLink: "/solaria-co2-laser-oswego-il",
    icon: "✨",
  },
  {
    id: "quantum-rf",
    title: "QuantumRF",
    description: "Pre & post care for subdermal RF skin tightening. Includes compression garment guidance.",
    viewOnline: "/pre-post-care/quantum-rf",
    serviceLink: "/quantum-rf-oswego-il",
    icon: "🎯",
  },
  {
    id: "microneedling",
