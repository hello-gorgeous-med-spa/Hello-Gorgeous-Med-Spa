...
const careGuides = [
  ...
  },
  {
    ...
    description: "Pre and post care for Morpheus8 face & body RF microneedling.",
    viewOnline: "/aftercare/morpheus8",
    serviceLink: "/services/morpheus8",
    icon: "⚡",
  },
  {
    id: "quantum-rf",
    title: "Quantum RF Skin Tightening",
    description: "Pre and post care for Quantum RF subdermal skin tightening.",
    viewOnline: "/aftercare/quantum-rf",
    serviceLink: "/services/quantum-rf",
    icon: "🎯",
  },
  {
    id: "solaria-co2",
    title: "Solaria CO₂ Laser",
    description: "Pre and post care for Solaria fractional CO₂ laser resurfacing.",
    viewOnline: "/aftercare/solaria-co2",
    serviceLink: "/stretch-mark-treatment-oswego-il",
    icon: "✨",
  },
  {
    id: "chemical-peel",
