...
export function generateMetadata({ params }: { params: { service: string } }): Metadata {
  ...
  if (!s) {
    return pageMetadata({
      title: "Montgomery, IL Service",
      description: "Service details for Montgomery, IL.",
      path: "/montgomery-il",
    });
  }

  return pageMetadata({
    title: `${s.name} Near Montgomery, IL | Hello Gorgeous Med Spa`,
    description: `${s.name} for Montgomery, IL residents — ${s.short} Book a consultation at Hello Gorgeous Med Spa in Oswego.`,
    path: `/montgomery-il/${s.slug}`,
  });
}
...
function locationFaqs(serviceName: string) {
  return [
    {
      question: `Do you offer ${serviceName} for Montgomery clients?`,
      answer: "Yes—Hello Gorgeous Med Spa serves clients from Montgomery. Our clinic is located in nearby Oswego, IL.",
    },
    {
    ...
    },
    {
      ...
      answer: "Our clinic is located at 74 W. Washington St., Oswego, IL 60543 — close to Montgomery.",
    },
  ];
}

export default function MontgomeryServicePage({ params }: { params: { service: string } }) {
  ...
  const breadcrumbs = [
    ...
    { name: s.name, url: `${SITE.url}/montgomery-il/${s.slug}` },
  ];
  ...
  return (
    <>
        ...
        <div className="relative z-10">
          <FadeUp>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <CTA href="/montgomery-il" variant="outline">
                Back to Montgomery hub
              </CTA>
            </div>
          ...
          <div className="lg:col-span-7">
            <FadeUp>
              <h2 className="text-3xl md:text-4xl font-bold text-white">
                {s.name} for Montgomery residents
              </h2>
              <p className="mt-4 text-white/70 max-w-2xl">
                This page helps Montgomery clients understand next steps. For full details and FAQs,
            ...
            <div className="mt-10 grid gap-4">
              {[
                ...
                { t: "Serving Montgomery", b: "Convenient for Montgomery clients — just minutes to our Oswego location." },
              ].map((x, idx) => (
      ...
      <Section>
        <FadeUp>
          <h2 className="text-3xl md:text-4xl font-bold text-white">Montgomery FAQ</h2>
          <p className="mt-4 text-white/70 max-w-2xl">
            Quick answers for local patients searching for {s.name} near Montgomery, IL.
          </p>
        </FadeUp>
