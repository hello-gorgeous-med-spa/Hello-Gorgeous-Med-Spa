...
export default function MontgomeryHubPage() {
  const hubProfile = getCityHubProfile("montgomery-il");
          ...
          <FadeUp>
            ...
            <p className="mt-6 text-xl text-black/80 max-w-3xl leading-relaxed">
              {hubProfile?.heroSubline ??
                "Hello Gorgeous Med Spa brings premium clinical aesthetics to Montgomery residents — luxury with medical oversight in nearby Oswego."}
            </p>
            ...
            <CityHubLocalBlock hubSlug="montgomery-il" />
          </FadeUp>
        </div>
      </Section>
