            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square relative rounded-2xl overflow-hidden border-4 border-[#FF2D8E]/30">
                  <Image
                    src="/images/hg-botox-face-neck-sm.webp"
                  ...
                  />
                  <Image
                    src="/images/hg-botox-face-neck.webp"
                    alt=""
                    fill
                    aria-hidden
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600 text-sm">a licensed Illinois clinician performs injections, with physician oversight from Dr. Mukesh Arora, MD.</p>
              </div>
              <div className="text-center p-6">
                <div className="w-16 h-16 bg-[#FF2D8E]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-3xl">✨</span>
