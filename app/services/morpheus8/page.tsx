        ...
        <section className="py-16 md:py-20 bg-black text-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                <Image
                  ...
                  alt="AccuTite and Morpheus8 before and after - under eye and eyelid tightening"
                  width={600}
                  height={400}
                  className="w-full h-auto"
                />
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-4">
                  ...
                  <p className="text-white/60 text-sm">FaceTite RF</p>
                </div>
              </div>
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                <Image
                  ...
                  alt="QuantumRF 25 and Morpheus8 before and after - abdomen skin tightening"
                  width={600}
                  height={400}
                  className="w-full h-auto"
                />
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                <Image
                  ...
                  alt="Morpheus8 Burst Deep before and after - cellulite reduction on buttocks"
                  width={600}
                  height={400}
                  className="w-full h-auto"
                />
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-4">
                  ...
                  <p className="text-white/60 text-sm">BodyTite RF</p>
                </div>
              </div>
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-4">
                  <p className="text-white font-medium">Face Contouring</p>
                  <p className="text-white/60 text-sm">QuantumRF 10 Pin</p>
                </div>
              </div>
              ...
              <div className="group relative rounded-xl overflow-hidden bg-zinc-900">
                <Image
                  ...
                  alt="QuantumRF 25 before and after - abdomen contouring"
                  width={600}
                  height={400}
                  className="w-full h-auto"
                />
            ...
            <p className="text-center text-white/50 text-sm mt-8">
              * Results shown are from InMode clinical studies and certified providers. Individual results may vary.
            </p>
          </div>
        </section>
