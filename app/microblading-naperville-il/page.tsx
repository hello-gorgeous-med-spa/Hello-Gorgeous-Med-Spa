...
const content = getBrowMicrobladingCitySeo("naperville");
...
export default function MicrobladingNapervillePage() {
  return <BrowMicrobladingCityRoutePage slug="naperville" />;
}
