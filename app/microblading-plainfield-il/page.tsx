...
const content = getBrowMicrobladingCitySeo("plainfield");
...
export default function MicrobladingPlainfieldPage() {
  return <BrowMicrobladingCityRoutePage slug="plainfield" />;
}
