    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-black to-black">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {/* iPhone Instructions */}
          <div className="bg-black rounded-2xl border border-black p-6">
        ...
        <div className="bg-black rounded-2xl border border-black p-6 mb-12">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-3xl">💻</span>
      ...
      {/* Footer */}
      <footer className="bg-black border-t border-black py-8 mt-12">
