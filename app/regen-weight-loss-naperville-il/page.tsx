...
const content = getRegenWeightLossCitySeo("naperville");
...
export default function RegenWeightLossNapervillePage() {
  return <RegenWeightLossCityRoutePage slug="naperville" />;
}
