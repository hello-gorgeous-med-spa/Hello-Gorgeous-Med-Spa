      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border p-6">
            <h3 className="font-semibold text-black mb-4">Quick Templates</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {SMS_TEMPLATES.slice(0, 9).map(template => (
                ...
                >
                  ...
                  <div className="text-xs text-black capitalize">{template.category}</div>
                </button>
              ))}
            </div>
          </div>
          ...
          {/* Message Input */}
          <div className="bg-white rounded-xl border p-6">
            <h3 className="font-semibold text-black mb-4">Your Message</h3>
            <textarea
              value={message}
              onChange={(e) => {
              ...
              className="w-full h-40 px-4 py-3 border border-black rounded-lg resize-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
            />
            <div className="flex justify-between mt-2 text-sm">
              <span className={charCount > 160 ? 'text-amber-600' : 'text-black'}>
          ...
          {/* Recipients */}
          <div className="bg-white rounded-xl border p-6">
            <h3 className="font-semibold text-black mb-4">Recipients</h3>
            <div className="flex gap-4 mb-4">
              ...
              >
                ...
                <div className="text-sm text-black">~{clientCount.toLocaleString()} clients with SMS opt-in</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-sm text-black">Enter phone numbers manually</div>
              </button>
            </div>
            ...
            {recipients === 'custom' && (
              <textarea
                ...
                className="w-full h-32 px-4 py-3 border border-black rounded-lg resize-none"
              />
            )}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border p-6">
            ...
            <div className="bg-black rounded-3xl p-4 max-w-[280px] mx-auto">
              <div className="bg-black rounded-2xl p-3">
                ...
                {mediaUrl && (
                  <div className="mt-2 bg-black rounded-lg p-2 text-center text-black text-xs">
                    📷 Image attached
                  </div>
                )}
              </div>
          ...
          {estimatedCost && (
            <div className="bg-white rounded-xl border p-6">
              <h3 className="font-semibold text-black mb-4">Cost Estimate</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-black">Cost (SMS)</span>
                  <span className="font-medium text-green-600">{estimatedCost.smsCost}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-black">Est. Time</span>
                ...
                <div className="border-t pt-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-black">vs typical platforms</span>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-4 bg-white text-black font-medium rounded-xl hover:bg-white disabled:opacity-50"
            >
              📱 Send Test to Myself
            </button>
            <button
