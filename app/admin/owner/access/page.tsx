...
export default function SystemAccessPage() {
  const [systems] = useState<SystemAccess[]>([
    ...
    { id: 'twilio', name: 'Twilio', category: 'SMS', description: 'Transactional and marketing SMS', status: 'verified', url: 'https://console.twilio.com', owner: 'danielle@hellogorgeousmedspa.com', lastVerified: '2025-03-24' },
    { id: 'telnyx-voice', name: 'Telnyx', category: 'Voice', description: 'AI voice receptionist (optional)', status: 'verified', url: 'https://portal.telnyx.com', owner: 'danielle@hellogorgeousmedspa.com', lastVerified: '2025-01-30' },
