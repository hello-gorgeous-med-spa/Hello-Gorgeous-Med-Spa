...
By signing below, you agree to these policies.`,
  ...
  {
    id: 'consent-morpheus8',
    name: 'Morpheus8 RF Microneedling Consent',
    description: 'Morpheus8 face & body RF microneedling',
    category: 'treatment',
    content: `INFORMED CONSENT FOR MORPHEUS8 RF MICRONEEDLING

I understand that I am receiving Morpheus8 treatment, which combines fractional RF energy with microneedling to improve skin texture, tone, laxity, and contour on the face and/or body.

RISKS: Redness, swelling, tenderness (2–5 days); bruising, dryness; rare: hyperpigmentation, scarring, infection, nerve injury.

I confirm: I am NOT pregnant or breastfeeding; no active infection or pacemaker in treatment area; I have disclosed medications. I will follow pre/post instructions and consent to before/after photos.`,
    fields: [
      { id: 'f1', type: 'checkbox', label: 'I am NOT pregnant or breastfeeding', required: true },
      { id: 'f2', type: 'checkbox', label: 'I have disclosed all medications and have no contraindications', required: true },
      { id: 'f3', type: 'checkbox', label: 'I understand the risks and consent to before/after photos', required: true },
      { id: 'f4', type: 'signature', label: 'Patient Signature', required: true },
      { id: 'f5', type: 'date', label: 'Date', required: true },
    ],
    requires_signature: true,
    expires_days: 365,
    is_active: true,
  ...
  {
    id: 'consent-quantum-rf',
    name: 'Quantum RF Skin Tightening Consent',
    description: 'Quantum RF subdermal skin tightening',
    category: 'treatment',
    content: `INFORMED CONSENT FOR QUANTUM RF SKIN TIGHTENING

I understand that I am receiving Quantum RF treatment, a minimally invasive procedure using subdermal RF energy to tighten loose skin (e.g. chin/neck, abdomen, arms, buttocks).

RISKS: Swelling, bruising, tenderness; temporary numbness; rare: infection, scarring, asymmetry, nerve injury. Local anesthesia will be used; I will follow compression and aftercare instructions.

I confirm: I am NOT pregnant or breastfeeding; no pacemaker or active infection; I have disclosed medical history. I understand this is elective.`,
    fields: [
      { id: 'f1', type: 'checkbox', label: 'I am NOT pregnant or breastfeeding', required: true },
      { id: 'f2', type: 'checkbox', label: 'I have disclosed all medications and medical history', required: true },
      { id: 'f3', type: 'checkbox', label: 'I understand the risks and agree to follow aftercare', required: true },
      { id: 'f4', type: 'signature', label: 'Patient Signature', required: true },
      { id: 'f5', type: 'date', label: 'Date', required: true },
    ],
    requires_signature: true,
  ...
  {
    id: 'consent-solaria-co2',
    name: 'Solaria CO₂ Laser Consent',
    description: 'Solaria fractional CO₂ laser resurfacing',
    category: 'treatment',
    content: `INFORMED CONSENT FOR SOLARIA CO₂ LASER TREATMENT

I understand that I am receiving fractional CO₂ laser treatment (Solaria) for skin resurfacing (e.g. wrinkles, scars, stretch marks, texture, tone).

RISKS: Redness, swelling, oozing, crusting; itching, dryness; possible hyper/hypopigmentation; rare: scarring, infection, cold sore flare. Eye protection will be used.

I confirm: I am NOT pregnant or breastfeeding; no active infection or cold sores; I have disclosed Accutane use and medications. I will avoid sun and use sunscreen as directed. I consent to before/after photos.`,
    fields: [
      { id: 'f1', type: 'checkbox', label: 'I am NOT pregnant or breastfeeding', required: true },
      { id: 'f2', type: 'checkbox', label: 'I have disclosed all medications and will follow sun/sunscreen instructions', required: true },
      { id: 'f3', type: 'checkbox', label: 'I understand the risks and consent to before/after photos', required: true },
      { id: 'f4', type: 'signature', label: 'Patient Signature', required: true },
      { id: 'f5', type: 'date', label: 'Date', required: true },
    ],
