...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { href: '/admin/sales', label: 'Sales Ledger', icon: '📊', description: 'All transactions' },
      { href: '/admin/sales/wallet', label: 'Business Wallet', icon: '💼', description: 'Cash & deposits' },
      { href: '/admin/sales/daily-summary', label: 'Daily Summary', icon: '📅', description: 'End of day' },
      { href: '/admin/payments', label: 'Payment History', icon: '💰', description: 'Transaction log' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/marketing/assistant', label: 'Marketing Assistant', icon: '🤖', description: 'AI campaign suggestions' },
      { href: '/admin/marketing/contacts', label: 'Contact Collection', icon: '📋', description: 'Sign-up links & QR codes' },
      ...
      { href: '/admin/marketing', label: 'All Marketing', icon: '📣', description: 'Campaigns & email' },
    ],
  },
  {
    title: 'Team & settings',
