...
Mention "Glow Event" when you book. Oswego, IL — serving Naperville, Aurora, Plainfield.`,
  ...
  },
  {
    ...
    type: 'Update',
    headline: 'VIP model spots filled — $500 off any area in Sept & Oct',
    description: 'All 20 VIP model spots are filled. Purchase any treatment area in September or October and get $500 off. 0% financing through Cherry for qualified clients. Consult required.',
    ctaText: 'See $500 off',
    ctaUrl: 'https://www.hellogorgeousmedspa.com/vip-model',
  },
  {
