    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Configure booking rules, cancellation policy, and deposits</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-white">
            ...
            <p className="text-sm text-gray-500 mt-1">Control who can book and when</p>
          </div>
          <div className="p-5 space-y-4">
            ...
            <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-500">Patients can book appointments for today</p>
              </div>
              <input
                type="checkbox"
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-white">
            ...
            <p className="text-sm text-gray-500 mt-1">Set lead time and booking increments</p>
          </div>
          <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1">How far in advance patients must book</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500"
              />
              <p className="text-xs text-gray-400 mt-1">How far in advance patients can book</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Time slot intervals shown to patients</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500"
              />
              <p className="text-xs text-gray-400 mt-1">Extra time between appointments</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-red-50 to-white">
            ...
            <p className="text-sm text-gray-500 mt-1">Protect provider time with cancellation fees</p>
          </div>
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500"
                />
                <p className="text-xs text-gray-400 mt-1">Hours before appointment for free cancellation</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500"
                />
                <p className="text-xs text-gray-400 mt-1">Percentage of service price charged</p>
              </div>
            </div>
            ...
            <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-500">Collect card details at booking to enforce policy</p>
              </div>
              <input
                type="checkbox"
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <div className="p-5 border-b border-gray-100 bg-gradient-to-r from-green-50 to-white">
            ...
            <p className="text-sm text-gray-500 mt-1">Collect deposits at booking to reduce no-shows</p>
          </div>
          <div className="p-5 space-y-4">
            <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Enable Service Deposits</p>
                <p className="text-sm text-gray-500">Collect partial payment at booking</p>
              </div>
              <input
                type="checkbox"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      min={0}
                      max={100}
                      className="w-24 px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-pink-500"
                    />
                    <span className="text-gray-500">%</span>
                  </div>
                  <p className="text-xs text-gray-400 mt-1">Can be overridden per service</p>
                </div>

                <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">Require Deposit for New Clients</p>
                    <p className="text-sm text-gray-500">First-time patients must pay deposit</p>
                  </div>
                  <input
                    type="checkbox"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            ...
            className="p-5 bg-white rounded-xl border border-gray-200 hover:border-pink-200 hover:shadow-md transition-all group"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Provider Schedules</h3>
                <p className="text-sm text-gray-500">Set working hours & availability</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Manage patient waitlist</p>
              </div>
            </div>
          </Link>
