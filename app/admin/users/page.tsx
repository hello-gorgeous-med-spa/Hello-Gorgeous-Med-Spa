  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-black p-6 text-black">
        <p className="font-medium">User permissions and access</p>
        <p className="text-sm mt-1 text-black/80">Manage who can access the admin and which roles they have (Owner, Manager, Provider, Front Desk). Configure in a future release or via your auth provider.</p>
