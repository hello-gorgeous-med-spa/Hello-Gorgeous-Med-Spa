  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-black p-6 text-black">
        ...
        <p className="text-sm mt-1 text-black/80">View a history of admin actions (who changed what and when). Required for compliance. Full audit log in a future release.</p>
