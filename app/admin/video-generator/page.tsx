              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <button
                    ...
                    className="w-full h-32 border-2 border-dashed border-pink-500/50 rounded-xl flex flex-col items-center justify-center hover:border-pink-400 hover:bg-pink-500/10 transition-colors bg-white/10"
                  >
                    {beforeImage ? (
