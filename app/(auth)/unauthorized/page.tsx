        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <div className="bg-white rounded-lg p-4 mb-6 text-left text-sm">
            <div className="flex justify-between mb-2">
              <span className="text-black">Your Role:</span>
              <span className="font-medium text-black capitalize">{currentRole}</span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/"
              className="block w-full px-4 py-3 bg-white hover:bg-white text-black font-medium rounded-lg transition-colors"
            >
              Go to Homepage
            </Link>
          </div>
