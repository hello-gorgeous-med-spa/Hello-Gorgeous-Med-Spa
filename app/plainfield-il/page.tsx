...
export const metadata: Metadata = pageMetadata({
  title: "Med Spa Near Plainfield, IL",
  description:
    "Hello Gorgeous Med Spa — luxury clinical aesthetics near Plainfield, IL. Botox/Dysport/Jeuveau, dermal fillers, weight loss prescriptions, hormone therapy, microneedling, IV therapy, and more.",
  path: "/plainfield-il",
});
...
function pageFaqs() {
  return [
    {
      question: "Do you serve clients from Plainfield, IL?",
      answer:
        "Yes—Hello Gorgeous Med Spa serves clients from Plainfield and the surrounding area. Our clinic is located in Oswego, IL.",
    },
    {
      ...
      <Section>
        <FadeUp>
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Popular services for Plainfield clients
          </h2>
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            <FadeUp delayMs={120}>
              <ServiceExpertWidget serviceName="Getting started" slug="plainfield-intro" category="Clinical" />
            </FadeUp>
          </div>
        </div>
      </Section>
