...
export const metadata: Metadata = {
  ...
  description:
    "Laser hair removal memberships from $69/month. We beat competitor prices by 30%. Small, Medium, Large & Full Body plans. Guaranteed permanent results. Oswego, Naperville, Aurora.",
  keywords: [
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {LASER_HAIR_MEMBERSHIPS.tiers.map((tier) => (
              ...
              >
                ...
                <div className="aspect-[4/3] relative bg-gradient-to-br from-[#FF2D8E]/10 to-black/5">
                  <Image
                    src={tier.image}
