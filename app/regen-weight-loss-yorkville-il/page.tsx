...
const content = getRegenWeightLossCitySeo("yorkville");
...
export default function RegenWeightLossYorkvillePage() {
  return <RegenWeightLossCityRoutePage slug="yorkville" />;
}
