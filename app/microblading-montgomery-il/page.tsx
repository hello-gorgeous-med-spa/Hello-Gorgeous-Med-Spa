...
const content = getBrowMicrobladingCitySeo("montgomery");
...
export default function MicrobladingMontgomeryPage() {
  return <BrowMicrobladingCityRoutePage slug="montgomery" />;
}
