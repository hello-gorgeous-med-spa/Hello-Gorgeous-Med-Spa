...
const baseMeta = pageMetadata({
  ...
  description:
    "Testosterone, bioidentical HRT, and lab-guided hormone optimization — a licensed Illinois clinician. RE GEN intake, provider consult, clinic pickup or ship to door.",
  path: PAGE_PATH,
  keywords: [
    "RE GEN hormones",
    "TRT Oswego",
