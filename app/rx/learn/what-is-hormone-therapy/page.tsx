...
import { WHAT_IS_HORMONE_THERAPY_ARTICLE } from "@/lib/regen-learn-articles";
...
const article = WHAT_IS_HORMONE_THERAPY_ARTICLE;
...
export default function WhatIsHormoneTherapyPage() {
