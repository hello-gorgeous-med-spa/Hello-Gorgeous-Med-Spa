  ...
  useEffect(() => {
    if (!authLoading && isAuthenticated && user) {
      ...
      if (returnTo && !returnTo.includes('://')) {
        ...
        if (user.role === 'owner') window.location.href = '/admin/owner';
        else if (user.role === 'admin' || user.role === 'staff') window.location.href = '/admin';
        else if (user.role === 'provider') window.location.href = '/provider';
