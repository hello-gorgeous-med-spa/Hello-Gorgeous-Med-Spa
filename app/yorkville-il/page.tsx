...
export const metadata: Metadata = pageMetadata({
  title: "Med Spa Near Yorkville, IL | Botox, Fillers, Weight Loss",
  description:
    "Hello Gorgeous Med Spa serves Yorkville, IL with luxury clinical aesthetics. Botox, dermal fillers, Semaglutide weight loss, hormone therapy, microneedling & more. Located in nearby Oswego.",
  path: "/yorkville-il",
});
...
function pageFaqs() {
  return [
    {
      question: "Do you serve clients from Yorkville, IL?",
      answer:
        "Yes! Hello Gorgeous Med Spa is located in Oswego, IL — just minutes from Yorkville. We serve many clients from Yorkville and surrounding Kendall County communities.",
    },
    {
...
export default function YorkvilleHubPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusinessJsonLd("Yorkville, IL")) }}
      />
      <script
        type="application/ld+json"
      ...
      <Section>
        <FadeUp>
          ...
          <p className="mt-4 text-black max-w-2xl">
            These are the most requested clinical and aesthetics services for our Yorkville patients.
          </p>
        </FadeUp>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {topServices.map((s, idx) => (
            <FadeUp key={s!.slug} delayMs={40 * idx}>
              <Link
                href={`/yorkville-il/${s!.slug}`}
                className="group block rounded-2xl border border-black bg-gradient-to-b from-black/60 to-black p-6 hover:border-[#E6007E] transition"
              >
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <FadeUp>
              <h2 className="text-3xl md:text-4xl font-bold text-white">
                Why Yorkville clients choose us
              </h2>
              <p className="mt-4 text-white/70 max-w-2xl">
                Just minutes from Yorkville, Hello Gorgeous offers the premium med spa experience 
            ...
            <div className="mt-10 grid gap-4">
              {[
                ...
                },
                {
                  ...
                  b: "Just a short drive from Yorkville to our Oswego clinic.",
                },
              ].map((x, idx) => (
      ...
      <Section>
        <FadeUp>
          ...
          <p className="mt-4 text-white/70 max-w-2xl">
            Common questions from Yorkville residents about our services.
          </p>
        </FadeUp>
        ...
        <div className="relative z-10">
          <FadeUp>
            <h2 className="text-3xl md:text-4xl font-bold text-black">
              Serving Yorkville &amp; Kendall County
            </h2>
            <p className="mt-4 text-black/80 max-w-2xl leading-relaxed">
              We&apos;re about a <strong>10-minute drive east on Route 34</strong> in downtown
              Oswego. Yorkville clients choose Hello Gorgeous for medical-grade care you can&apos;t
              get at a walk-in counter. New to us? Read{" "}
              <Link
                href="/blog/best-med-spa-near-yorkville-il-botox-weight-loss-morpheus8"
                className="font-semibold text-[#E6007E] underline decoration-[#E6007E]"
              >
                the best med spa near Yorkville, IL
              </Link>{" "}
