...
export const SITE_HERO_IMAGE = "/images/hero-brand.png?v=2026-06-16-founders" as const;
...
export const SERVICE_IMAGES: ServiceImage[] = [
  ...
  },
  {
    ...
    title: "Quantum RF Procedure — Body Contouring",
    service: "Quantum RF",
    category: "aesthetics",
  },
  {
    src: "/images/quantum-rf/quantum-rf-treatment-room-may-4.jpg",
    alt: "Quantum RF by InMode treatment room at Hello Gorgeous Med Spa in Oswego, IL",
    title: "Quantum RF Treatment Room",
    service: "Quantum RF",
    category: "aesthetics",
  },
  {
  ...
  },
  {
    ...
    alt: "Natural light stroke brows before and after microblading hair strokes by Danielle Alcala at Hello Gorgeous Med Spa Oswego IL",
    title: "Natural Light Stroke Brows Before & After",
