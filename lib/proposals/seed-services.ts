...
const WELLNESS_SERVICES: SeedService[] = [
  ...
  { id: "flowwave-single", name: "FlowWave Single Session", category: "Body & Wellness", price: 175, unit: "per session", description: "One focused shockwave session, any single area." },
  { id: "flowwave-5pack", name: "FlowWave 5-Session Package", category: "Body & Wellness", price: 749, unit: "per package", description: "5 focused sessions — $150/session, save 14%." },
  { id: "flowwave-6pack", name: "FlowWave 6-Session Package", category: "Body & Wellness", price: 870, unit: "per package", description: "6 focused sessions — $145/session, save 17%." },
  { id: "flowwave-10pack", name: "FlowWave 10-Session Package", category: "Body & Wellness", price: 1199, unit: "per package", description: "10 focused sessions — $120/session, save 31%." },
  { id: "flowwave-12pack", name: "FlowWave 12-Session Package", category: "Body & Wellness", price: 1500, unit: "per package", description: "12 focused sessions — $125/session, save 29%." },
  { id: "flowwave-24pack", name: "FlowWave 24-Session Package", category: "Body & Wellness", price: 2376, unit: "per package", description: "24 focused sessions — as low as $99/session, save 43%." },
