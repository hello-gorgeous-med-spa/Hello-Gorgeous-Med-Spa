...
export const DERMAL_FILLERS_OSWEGO_MENU = buildOswegoMenu("dermal-fillers-oswego", {
  ...
  titleAccent: "$599/syringe",
  pricingTitle: "Dermal filler pricing",
  pricingHighlights: [
    "$599 per syringe · half syringe $300 · buy 2 save $100",
  ...
  pricingRows: [
    { label: "Half syringe", price: "$300", note: "Targeted touch-ups" },
    { label: "Dermal filler (per syringe)", price: "$599", note: "Product varies by area" },
    { label: "2-syringe package", price: "$1,098", note: "Save $100 vs two singles" },
    { label: "Lip filler — 1 syringe", price: "$599", href: "/lip-filler-oswego" },
...
export const LIP_FILLER_OSWEGO_MENU = buildOswegoMenu("lip-filler-oswego", {
  ...
  titleAccent: "$599 per syringe",
  pricingTitle: "Lip filler pricing",
  pricingHighlights: [
    "Half syringe $300 · full syringe $599 · buy 2 save $100",
    "Perfect for subtle starts or full enhancement",
    "Conservative dosing — build naturally over time",
    "Numbing cream + lidocaine in the filler itself",
    "Free consultation with photos for comparison",
  ],
  pricingRows: [
    { label: "Half syringe", price: "$300", note: "Subtle starts & maintenance" },
    { label: "Lip filler — 1 syringe", price: "$599" },
    { label: "Lip filler — 2 syringes", price: "$1,098", note: "Save $100 vs two singles" },
