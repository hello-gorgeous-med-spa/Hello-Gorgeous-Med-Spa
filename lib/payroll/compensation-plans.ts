...
export const COMPENSATION_PLANS: StaffCompensationPlan[] = [
  ...
  },
  {
    ...
    role: "Office Manager · Laser Hair Tech · Certified InMode Instructor (1099)",
    ...
    notes: [
      "1099 independent contractor — paid weekly via Square Payroll contractor payouts; contractor responsible for own taxes.",
      "$22/hr for tracked working time — office manager duties (including when owner is away), training/certification, and treatments.",
      "Training on Morpheus8, Solaria, FlowWave/shockwave, laser hair, and weight loss/peptides is paid at the hourly rate; InMode + manufacturer reps available for training and practice.",
      "Production commission: 20% of (collected price − consumable COGS) on her five modalities only — attributed at Square checkout.",
      "COGS = Cost of Goods Sold (supply cost to deliver the treatment). Morpheus8 needle $125/session · Solaria $0 · Shockwave/FlowWave $0 · Laser hair $0 · WL/peptides $75/line midpoint until SKU costs locked.",
      "Example: Morpheus8 $799 − $125 needle = $674 × 20% = $134.80 commission.",
      "Example: Solaria $899 − $0 = $899 × 20% = $179.80 commission.",
      "Personal staff portal access for consultations, proposals, and related workflows; partners with Laura on marketing/social content.",
      "Perks: Hello Gorgeous services at cost; family discount code for loved ones (terms set by owner).",
