...
export const SERVICES_MENU_GOALS: ServiceMenuSection[] = [
  {
    ...
    items: [
      ...
      { id: "sculptra", name: "Sculptra & Biostimulator", href: "/services/sculptra-biostimulator", icon: "✨", badge: "new" },
  ...
  },
  {
    ...
    items: [
      { id: "solaria-sr", name: "Solaria CO₂ Laser", href: "/solaria-co2-oswego", icon: "✨" },
      { id: "ipl", name: "Lumecca IPL Photofacial", href: "/services/ipl-photofacial", icon: "💡", badge: "new" },
      { id: "salmon-dna", name: "Salmon DNA Glass Facial", href: "/services/salmon-dna-glass-facial", icon: "🧬", badge: "new" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sculptra-inj", name: "Sculptra & Biostimulator", href: "/services/sculptra-biostimulator", icon: "✨" },
