...
export const MEDICAL_TRUST_PROVIDERS = [
  ...
  },
  {
    ...
    role: "Physician Oversight · Internal Medicine",
    detail: "30+ years · collaborating MD for Hello Gorgeous",
    image: "/images/providers/dr-mukesh-arora.jpg",
    imageAlt: `${DR_ARORA_FULL_NAME}, physician providing medical oversight for Hello Gorgeous Med Spa`,
    badge: "Collaborating physician",
  },
] as const;
...
/** @deprecated Prefer MD_OVERSIGHT_TEAM — now includes Dani with clinical credentials. */
export const MD_OVERSIGHT_PAIR = MEDICAL_TRUST_PROVIDERS;

export const DR_ARORA_PROFILE = {
  name: DR_ARORA_FULL_NAME,
  credentialsLine: "Internal Medicine · 30+ years of experience",
  ...
  whyWeChoseHim: [
    ...
    "That patient-first style is exactly the medical oversight culture we want behind Hello Gorgeous.",
  ] as const,
  patientThemes: [
    {
      title: "Never rushed",
