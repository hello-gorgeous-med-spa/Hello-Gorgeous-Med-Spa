...
export const sculptraBiostimulatorSeo: TreatmentSeoConfig = {
  ...
  heroBody:
    "At Hello Gorgeous Med Spa in Oswego, IL, we offer FDA-approved biostimulators including Sculptra® (PLLA) for clients who want long-lasting collagen support — cheeks, temples, jawline, and global facial harmony. Medical oversight by a licensed Illinois clinician, six days a week.",
  ...
  treats: [
    ...
    { icon: "👩‍⚕️", title: "NP-Led Assessment", desc: "a licensed Illinois clinician, on site six days a week — not a remote signature." },
...
export const salmonDnaGlassFacialSeo: TreatmentSeoConfig = {
  ...
  whyUs: [
    ...
    "Danielle has 10+ years in Oswego; a licensed Illinois clinician, provides medical oversight on site.",
