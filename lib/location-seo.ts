...
export const TOP_SERVICES: ServiceConfig[] = [
  ...
  },
  {
    ...
    treatmentAreas: [
      { area: 'Face & Neck', detail: 'Tightening, wrinkles, pores' },
      { area: 'Body Contouring', detail: 'Abdomen, arms, thighs' },
      { area: 'Acne Scars', detail: 'Deep scar remodeling' },
      { area: 'Fat Reduction', detail: 'Submental, body areas' },
      { area: 'Stretch Marks', detail: 'Improve skin texture' },
      { area: 'Jowls & Jawline', detail: 'Tighten and define' },
    ],
    benefits: [
      { icon: '🔬', title: 'Deepest RF', desc: 'Up to 8mm depth — deeper than any other device' },
      { icon: '⚡', title: 'Burst Technology', desc: 'Multi-depth energy in a single pulse' },
      { icon: '🎯', title: 'Quantum Probes', desc: '10, 17, 25 pin options for precision' },
      { icon: '✨', title: 'Face + Body', desc: 'Treat virtually any area' },
    ],
    faqs: [
      { question: 'What is Morpheus8?', answer: 'Morpheus8 is an FDA-cleared fractional RF microneedling device that combines gold-coated microneedles with radiofrequency energy, penetrating up to 8mm deep for dramatic collagen remodeling and fat reduction.' },
      { question: 'How many sessions do I need?', answer: 'Most clients see optimal results with 3 treatments spaced 4-6 weeks apart. Results continue improving for 3-6 months as collagen rebuilds.' },
      { question: 'What is the downtime?', answer: 'Expect 2-5 days of redness, mild swelling, and pinpoint marks. Most clients return to normal activities within 3-4 days.' },
      { question: 'Can Morpheus8 treat body areas?', answer: 'Yes! Morpheus8 with Burst technology is excellent for body contouring, treating abdomen, arms, thighs, and more for skin tightening and fat reduction.' },
    ],
  },
  {
  ...
  },
  {
    ...
    shortName: 'Sculptra',
    priceDisplay: 'Consult for quote',
    description: 'Collagen biostimulator injectables including Sculptra® in Oswego, IL — gradual volume and skin quality, medically supervised.',
    heroImage: '/images/services/hg-dermal-fillers.png',
    keywords: ['sculptra oswego', 'biostimulator oswego il', 'sculptra naperville', 'collagen stimulator', 'PLLA filler', 'sculptra med spa', 'biostimulator injectable'],
    benefits: [
      { icon: '✨', title: 'Collagen Banking', desc: 'Results build over weeks' },
      { icon: '🎯', title: 'Structure', desc: 'Temples, cheeks, jawline support' },
      { icon: '👩‍⚕️', title: 'NP On Site', desc: 'a licensed Illinois clinician, 6 days a week' },
      { icon: '📍', title: 'Oswego Since 2015', desc: '10+ years in the Fox Valley' },
    ],
    faqs: [
      { question: 'What is Sculptra?', answer: 'Sculptra is an FDA-approved biostimulator (PLLA) that signals your body to produce collagen for gradual, natural-looking volume and skin quality improvement.' },
      { question: 'How is Sculptra different from filler?', answer: 'HA fillers add immediate volume. Sculptra stimulates collagen over a series of treatments — better when the goal is longevity and structure, not same-day plump.' },
      { question: 'Where can I get Sculptra in Oswego?', answer: 'Hello Gorgeous Med Spa at 74 W Washington St, Oswego, IL. We serve Naperville, Aurora, Plainfield, and surrounding areas.' },
    ],
  },
  {
    ...
    benefits: [
      ...
      { icon: '✨', title: 'Glass Skin Glow', desc: 'Event-ready radiance' },
      { icon: '💡', title: 'Stack Options', desc: 'Microneedling, IPL, or peel' },
      { icon: '🔗', title: 'Full Regen Menu', desc: 'AnteAGE P.E.A.R.L. also available' },
    ],
    faqs: [
      { question: 'What is a salmon DNA facial?', answer: 'A regenerative facial using PDRN (polydeoxyribonucleotide) to support hydration, repair, and glow — often called a glass skin or red carpet facial.' },
      { question: 'Can I add IPL or microneedling?', answer: 'Yes. Our protocol lets us pair salmon DNA with the right modality for your skin goals.' },
      { question: 'Is this offered in Oswego?', answer: 'Yes at Hello Gorgeous Med Spa, 74 W Washington St, Oswego, IL 60543.' },
    ],
  },
  {
