...
export const QUANTUM_RF_OSWEGO_MENU = buildOswegoMenu("quantum-rf-oswego", {
  ...
  titleAccent: "From $800/area",
  secondaryCta: INMODE_SECONDARY,
  pricingTitle: "Quantum RF pricing",
  pricingHighlights: [
    "From $800 per area per session",
    "Series of 3–4 typical · 4–6 weeks apart",
    "Package pricing lowers per-session cost",
    "Abdomen · flanks · arms · thighs · neck · jawline",
    "Fat reduction AND skin tightening in one platform",
  ],
  pricingRows: [
    { label: "Quantum RF — per area", price: "From $800", note: "Per session" },
    { label: "Series of 3–4 package", price: "Consult", note: "Quoted by area & goals" },
    { label: "InMode Trifecta packages", price: "Specials →", href: "/specials" },
  ],
  pricingBadge: "EXCLUSIVE",
  howItWorksHighlights: [
