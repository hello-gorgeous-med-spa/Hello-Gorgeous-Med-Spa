...
export const SOLARIA_CO2_OSWEGO_MENU = buildOswegoMenu("solaria-co2-oswego", {
  ...
  titleAccent: "From $299 this September",
  secondaryCta: INMODE_SECONDARY,
  pricingTitle: "Solaria CO₂ pricing",
  pricingHighlights: [
    "September: full face, neck & chin $799 ($100 off · 23/7 numbing included)",
    "Neck, chin & chest $400 · under eyes only $299",
  ...
  pricingRows: [
    { label: "Full face, neck & chin", price: "$799", note: "$100 off · 23/7 numbing · Sept" },
    { label: "Neck, chin & chest", price: "$400", note: "September area special" },
    { label: "Under eyes only", price: "$299", note: "September area special" },
