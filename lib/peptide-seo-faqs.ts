...
export const PEPTIDES_HUB_FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Every protocol is reviewed under the medical oversight of Dr. Mukesh Arora, MD, and prescribed and managed by a licensed Illinois clinician.",
  },
  {
    question: "How does Hello Gorgeous RX work?",
    answer: `Start with a consult and intake — free to submit. A $${PEPTIDE_CONSULT_FEE_USD} fee reserves your visit with a licensed Illinois clinician. He reviews your history and labs and decides whether a prescription is appropriate. You are only billed for medication after approval.`,
  },
  {
    question: "How much does a Hello Gorgeous RX consult cost in Oswego?",
    answer: `New-patient consult is $${PEPTIDE_CONSULT_FEE_USD}. That reserves your visit with a licensed Illinois clinician. Medication, if prescribed, is billed separately after approval. Fees for routine professional services may be adjusted for labs, complexity, or dose. GLP-1 programs, when appropriate, start at $${GLP1_RETAIL_PROGRAM.semaglutideFromUsd}/mo for compounded semaglutide or $${GLP1_RETAIL_PROGRAM.tirzepatideFromUsd}/mo for compounded tirzepatide — not FDA-approved and not the same as branded Wegovy®, Zepbound®, Ozempic®, or Mounjaro®.`,
  },
  {
    question: "Do you publish a peptide menu online?",
    answer:
      "No. We advertise medical consultations, not a public compounded-peptide catalog. After evaluation, a licensed Illinois clinician decides whether a prescription is clinically appropriate. Compounded medications are not FDA-approved.",
  },
  {
