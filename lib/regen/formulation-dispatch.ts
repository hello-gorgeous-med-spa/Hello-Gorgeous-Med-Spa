...
> = {
  ...
  ici: { sku: "3978", daysSupply: 30, note: "Starting ICI 2.5mL — clinician may step BiMix/TriMix/QuadMix" },
  "ghk-cu": { sku: "3763", daysSupply: 30, note: "GHK-Cu topical solution 30mL · 0.25%" },
  hydroquinone: { sku: "3720", daysSupply: 30, note: "Hydroquinone 13% 30g" },
  cleartone: { sku: "3719", daysSupply: 30, note: "Brightening cream 30g HQ blend" },
  clarity: { sku: "3722", daysSupply: 30, note: "Azelaic / tretinoin / niacinamide 30g" },
  "fin-minox-solution": { sku: "3102", daysSupply: 30, note: "Minoxidil / finasteride / arginine 30mL" },
  blt: { sku: "2510", daysSupply: 30, note: "BLT cream 100g 20/6/4 — in-office" },
  "nad-injection": {
    sku: "3119",
    daysSupply: 30,
  ...
  "libido-women": { sku: "3078", daysSupply: 30, note: "Oxytocin troches 15ct · 10 IU — clinician may add PT-141" },
};
...
const ITEM_PROGRAM_HINTS: Array<{ pattern: RegExp; program: string }> = [
  ...
  { pattern: /tesamorelin/i, program: "tesamorelin" },
  { pattern: /sermorelin/i, program: "sermorelin" },
  { pattern: /growth & energy|cjc/i, program: "growth" },
  { pattern: /pt-?141|bremelanotide/i, program: "pt-141" },
  { pattern: /women.?s desire/i, program: "libido-women" },
  { pattern: /oxytocin/i, program: "oxytocin" },
  { pattern: /scream cream|arousal cream/i, program: "scream-cream" },
  { pattern: /\bici\b|trimix|bimix|quadmix|intracavern/i, program: "ici" },
