...
export const REGEN_PEPTIDE_PRICING: RegenProductPrice[] = [
  ...
  { id: "tb-500", name: "TB-500 Injection", category: "peptide-therapy", wholesale: 70, ...calcRetailPricing(70), priceLabel: "$175/vial", isFromPrice: false, rx: true },
  { id: "bpc-tb-combo", name: "BPC-157 / TB-500 Combo", category: "peptide-therapy", wholesale: 80, ...calcRetailPricing(80), priceLabel: "$200/vial", isFromPrice: false, rx: true },
  { id: "advanced-recovery", name: "BPC/GHK-Cu/KPV/TB-500 Blend", category: "peptide-therapy", wholesale: 80, ...calcRetailPricing(80), priceLabel: "$200/vial", isFromPrice: false, rx: true },
  { id: "heal-blend", name: "HEAL Blend (BPC/KPV/TB-500)", category: "peptide-therapy", wholesale: 80, ...calcRetailPricing(80), priceLabel: "$200/vial", isFromPrice: false, rx: true },
  // GH-Axis Support
  { id: "sermorelin-6ml", name: "Sermorelin Injection 1.5mg/mL 4mL", category: "peptide-therapy", wholesale: 60, ...calcRetailPricing(60), priceLabel: "$150/vial", isFromPrice: true, rx: true, coldShip: true },
  { id: "sermorelin-6ml-1.5", name: "Sermorelin Injection 2.5mg/mL 6mL", category: "peptide-therapy", wholesale: 90, ...calcRetailPricing(90), priceLabel: "$225/vial", isFromPrice: false, rx: true, coldShip: true },
  ...
  // Skin + Glow
  { id: "glutathione-5ml", name: "Glutathione Injection 10mL", category: "peptide-therapy", wholesale: 40, ...calcRetailPricing(40), priceLabel: "$100/vial", isFromPrice: true, rx: false },
