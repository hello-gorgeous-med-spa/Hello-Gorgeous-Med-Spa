...
export const TRYREGEN_BUNDLES: TryregenBundle[] = [
  {
    ...
    name: "Recovery Blend",
    tagline: "Repair",
    description: "One BoomRx vial — BPC-157 / TB-500. Ryan decides if it is appropriate.",
  ...
  },
  {
    ...
    tagline: "Skin",
    description: "One BoomRx vial — BPC-157 / TB-500 / GHK-Cu.",
  ...
  },
  {
    ...
    tagline: "Repair",
    description: "One BoomRx vial — BPC-157 / GHK-Cu / KPV / TB-500.",
  ...
  },
  {
    ...
    name: "Heal Blend",
    tagline: "Repair",
    description: "One BoomRx vial — BPC-157 / KPV / TB-500.",
  ...
  },
  {
    ...
    tagline: "Energy",
    description: "CJC-1295 / Ipamorelin plus NAD+ — two BoomRx vials, one cold ship.",
  ...
  },
  {
    ...
    name: "Focus Blend",
    tagline: "Focus",
    description: "One BoomRx vial — Semax / Selank.",
  ...
  },
  {
    ...
    name: "NAD + Sermorelin",
    tagline: "Energy",
    description: "Cellular energy plus growth-hormone support — two BoomRx vials, one ship.",
  ...
  },
  {
    ...
    tagline: "Glow",
    description: "Glutathione + NAD+ — two BoomRx vials, one cold ship.",
