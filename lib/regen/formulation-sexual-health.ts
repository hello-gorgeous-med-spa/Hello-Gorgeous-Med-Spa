...
export const SEXUAL_HEALTH_GAPS: Array<{
  title: string;
  body: string;
  forms: string;
...
export const WOMENS_SEXUAL_CARDS: Array<{
  title: string;
  body: string;
  forms: string;
  shopId: FormulationShopId;
  ...
  },
  {
    ...
    forms: "Low-dose testosterone & DHEA · clinician-directed BHRT · oxytocin & PT-141 when prescribed",
    shopId: "libido-women",
  },
];
