...
export const TRT_OSWEGO_MENU = buildOswegoMenu("testosterone-replacement-oswego", {
  ...
  titleAccent: "Injections or Cream",
  secondaryCta: { label: "Hormone consult", href: "/book?service=biote-hormone-therapy" },
  ...
  pricingRows: [
    ...
    { label: "Hormone consult", price: "Book", href: "/book?service=biote-hormone-therapy", note: "Quote confirmed before you start" },
  ],
  pricingBadge: "MEN'S HEALTH",
  howItWorksHighlights: [
    "Restores testosterone to an age-appropriate clinical level",
    "Injections or cream — we help you pick what fits your life",
...
export const BIOTE_HORMONE_OSWEGO_MENU = buildOswegoMenu("biote-hormone-therapy-oswego", {
  eyebrow: "Oswego, IL · NP-supervised hormone optimization",
  titleBefore: "Hormone Therapy —",
  titleAccent: "Labs First, Then a Plan",
  primaryCta: { label: "Book hormone consult", href: "/book?service=biote-hormone-therapy" },
  secondaryCta: WELLNESS_SECONDARY,
  ...
  pricingBadge: "LABS FIRST",
  howItWorksHighlights: [
    "Symptoms and history first — then labs, then a protocol",
    "Olympia compounded options: testosterone, estradiol, progesterone, Biest",
    "Bioidentical hormones molecularly identical to your own",
    "Dose calculated from YOUR labs, symptoms, age & weight",
    "We no longer offer pellet insertion",
  ],
  howItWorksLinks: [
    { label: "TRT for men — injections or cream", price: "Compare →", href: "/testosterone-replacement-oswego" },
  ...
  whyRows: [
    ...
    { label: "Follow-up at 4–6 weeks", price: "Included", note: "Repeat labs as indicated" },
    { label: "Delivery method", price: "Your call", note: "Creams or injectables — not pellets" },
  ],
  whatToExpectDescription:
    "Free consult, comprehensive baseline labs, NP lab review with individualized dosing, then compounded creams or injectables when appropriate — medicine, not a vending machine. We no longer offer pellet insertion.",
  relatedDescription:
    "Hormones touch everything — energy, sleep, libido, mood, body composition. We often pair hormone optimization with weight loss or peptide programs.",
  relatedHighlights: [
    "TRT delivery options compared: injections vs cream",
