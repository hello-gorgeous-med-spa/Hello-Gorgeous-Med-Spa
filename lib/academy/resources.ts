...
export const RESOURCES: ResourceGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Staff-only patient visit record', desc: 'Michelle pulls before treatment: laser/device settings, reactions, tirzepatide volume + client charge, provider + desk sign-off. Chart copy — not for patients.', type: 'LINK', owner: 'Danielle', updated: 'Aug 2026', href: '/handouts/patient-packet/HG-Staff-Only-Visit-Record.html', external: true },
      { title: 'Tirzepatide Program Client Handout (HTML — editable)', desc: 'Editable printable HTML — booking menu, volume tiers vs $299 Monthly Maintenance, visit checklist. Open in browser → Print / Save as PDF. Edit the file anytime.', type: 'LINK', owner: 'Danielle', updated: 'Aug 2026', href: '/handouts/glp1/tirzepatide-program-handout.html', external: true },
      { title: 'Tirzepatide Program Client Handout (PDF)', desc: 'Static PDF copy of the same handout for quick print/share when you do not need to edit.', type: 'PDF', owner: 'Danielle', updated: 'Aug 2026', href: '/handouts/glp1/tirzepatide-program-client-handout.pdf', external: true },
