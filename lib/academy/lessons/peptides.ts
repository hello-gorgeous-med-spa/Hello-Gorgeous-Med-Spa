  ...
  p6: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Epitalon is studied for circadian rhythm and telomerase signaling — but the evidence is thin. MOTS-c is a mitochondrial-derived peptide studied for metabolic regulation.",
