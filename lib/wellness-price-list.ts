...
const HORMONE_ITEMS: WellnessPriceListItem[] = [
  {
    ...
    benefits: ["a licensed Illinois clinician", "Labs before dosing", "Creams & injectables"],
    image: "/images/ladies-club/weight-loss-hormones-women.png",
    imageAlt: "Women's hormone therapy — Hello Gorgeous Med Spa Oswego IL",
    href: "/book?service=biote-hormone-therapy",
    consultFirst: true,
  },
  {
    id: "trt-men",
    name: "Men's TRT consult",
    priceLabel: "Book",
    tagline: "Testosterone optimization · injections or cream",
    note: "Lab-guided TRT — we no longer offer pellet insertion.",
    benefits: ["Injections or cream", "Lab monitoring", "NP on site 6 days"],
    image: "/images/gentlemens-club/the-distinguished-hero.png",
    imageAlt: "Men's testosterone therapy — Hello Gorgeous Med Spa Oswego IL",
  ...
  },
  {
    ...
    note: "Labs, therapy initiation, monthly vitamin + IV perks",
    benefits: ["2 lab panels", "Compounded HRT options", "Monthly vitamin + IV"],
    consultFirst: true,
    href: "/rx/hormones",
  },
  {
  ...
  },
  {
    ...
    benefits: ["Flexible dosing", "Lab monitoring", "a licensed Illinois clinician"],
    image: "/images/gentlemens-club/the-distinguished-hero.png",
...
export const WELLNESS_PRICE_LIST_SECTIONS: WellnessPriceListSection[] = [
  ...
  },
  {
    ...
    intro: `Olympia-sourced IV formulas prescribed by a licensed Illinois clinician. Signature drips from $${IV_SIGNATURE_DRIP_FROM_USD} · NAD+ IV from $${NAD_PLUS_IV_FROM_USD}.`,
    items: buildIvItems(),
  ...
  },
  {
    ...
    eyebrow: "Bioidentical HRT · TRT · women's HRT",
    intro: "Lab-guided hormone optimization with a licensed Illinois clinician on site six days a week. Free hormone consult — your quote is confirmed before you commit. We no longer offer pellet insertion.",
    items: HORMONE_ITEMS,
    footerNote:
      "Hormone therapy and optimization-level monitoring are typically out-of-pocket. HSA/FSA eligible — itemized receipts available.",
  },
  {
    id: "memberships",
    number: "06",
    ...
    footerNote: "Membership fees are separate from medication and lab costs. Cancel anytime per plan terms.",
  },
];
...
export const WELLNESS_PRICE_LIST_FAQS = [
  ...
  },
  {
    ...
    a: "All protocols are prescribed and monitored by a licensed Illinois clinician with full prescriptive authority. We use licensed US compounding pharmacies, lab-guided dosing, and regular check-ins.",
  },
  {
