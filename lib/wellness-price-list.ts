...
const HORMONE_ITEMS: WellnessPriceListItem[] = [
  {
    ...
    benefits: ["Ryan Kent, FNP-BC", "Labs before dosing", "Creams & injectables"],
...
export const WELLNESS_PRICE_LIST_SECTIONS: WellnessPriceListSection[] = [
  ...
  },
  {
    ...
    intro: "Lab-guided hormone optimization with Ryan Kent, FNP-BC on site six days a week. Free hormone consult — your quote is confirmed before you commit. We no longer offer pellet insertion.",
    items: HORMONE_ITEMS,
    footerNote:
