...
export const HRT_PAYMENT_FIRST_COPY =
  "Pay in person on the Terminal at Hello Gorgeous in Oswego, then complete your NP visit. Nothing ships until a licensed Illinois clinician approves your protocol.";
