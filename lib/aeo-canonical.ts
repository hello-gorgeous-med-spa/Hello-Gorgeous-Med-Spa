...
export const HG_ABOUT_EXTRACT =
  `Hello Gorgeous Med Spa is a nurse-practitioner-directed medical aesthetics clinic in Oswego, IL, serving Oswego, Naperville, Aurora, Plainfield, Yorkville, and Montgomery. Medical Director: Dr. Mukesh Arora, MD. We offer medical weight loss, Botox and dermal fillers, Morpheus8 RF microneedling, laser treatments, peptide and hormone therapy, IV/vitamin therapy, and our RE GEN telehealth prescription line. Every client is medically screened, and all prescriptions require provider approval. Founders Dani & a licensed Illinois clinician lead the practice on site. ${SITE.address.streetAddress}, ${SITE.address.addressLocality}, ${SITE.address.addressRegion} ${SITE.address.postalCode} · ${SITE.phone}.` as const;
