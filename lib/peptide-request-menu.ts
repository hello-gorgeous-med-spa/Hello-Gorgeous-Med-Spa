...
export const PEPTIDE_REQUEST_ITEMS: PeptideRequestItem[] = [
  ...
  },
  {
    ...
    thumbnailSlug: "heal-blend",
    category: "Recovery & Healing",
    benefit: "Anti-inflammatory support for gut, skin & recovery",
    screeningSet: "recovery",
    rxRequired: true,
  },
  {
    ...
    thumbnailSlug: "bpc-157",
    category: "Recovery & Healing",
    benefit: "Needle-free tissue & gut support",
    screeningSet: "recovery",
    rxRequired: true,
  },
  {
    ...
    thumbnailSlug: "selank",
    category: "Cognitive & Mood",
    benefit: "Sleep-support peptide — cycle set at consult",
    screeningSet: "cognitive",
    rxRequired: true,
    investigational: true,
  },
  {
    ...
    thumbnailSlug: "nad-plus",
    category: "Cognitive & Mood",
    benefit: "Mitochondrial & cognitive support",
    screeningSet: "cognitive",
    rxRequired: true,
  },
  {
  ...
  },
  {
    ...
    thumbnailSlug: "amino-blend",
    category: "Recovery & Healing",
    benefit: "Immune-defense peptide — used when clinically appropriate",
    screeningSet: "general",
    rxRequired: true,
    investigational: true,
  },
  {
    ...
    thumbnailSlug: "amino-blend",
    category: "Recovery & Healing",
    benefit: "Immune-modulating peptide under NP supervision",
    screeningSet: "general",
    rxRequired: true,
    investigational: true,
  },
  {
    ...
    thumbnailSlug: "sermorelin",
    category: "Hormone & GH Support",
    benefit: "Natural hormone signaling & fertility support",
    screeningSet: "gh",
    rxRequired: true,
  },
  {
    ...
    thumbnailSlug: "sermorelin",
    category: "Hormone & GH Support",
    benefit: "Testicular & fertility support during hormone therapy",
    screeningSet: "gh",
    rxRequired: true,
  },
  {
    ...
    thumbnailSlug: "pt-141",
    category: "Hormone & GH Support",
    benefit: "Reproductive-hormone signaling",
    screeningSet: "gh",
    rxRequired: true,
    investigational: true,
  },
  {
    ...
    thumbnailSlug: "pt-141",
    category: "Intimacy & Vitality",
    benefit: "Bonding, mood & recovery support",
    screeningSet: "intimacy",
    rxRequired: true,
  },
  {
    ...
    thumbnailSlug: "tb-500",
    category: "Recovery & Healing",
    benefit: "Cardiovascular tissue-support peptide",
    screeningSet: "recovery",
    rxRequired: true,
    investigational: true,
  },
  {
    ...
    thumbnailSlug: "tb-500",
    category: "Recovery & Healing",
    benefit: "Neuropathic comfort & tissue-protection peptide",
    screeningSet: "recovery",
    rxRequired: true,
    investigational: true,
  },
  {
    ...
    thumbnailSlug: "glutathione",
    category: "Recovery & Healing",
    benefit: "Anti-inflammatory support for joints & recovery",
    screeningSet: "recovery",
    rxRequired: true,
  },
];
