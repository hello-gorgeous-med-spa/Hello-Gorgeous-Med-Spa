# HG_DEV_011 — Phase 1 Content (4 Uncontested Pages)

**Status:** Phase 1 of 2. Phase 1 covers the 4 uncontested keywords where we'll rank #1 fastest. Dani reviews voice; if approved, Phase 2 ships the remaining 19 pages with any voice adjustments.

**For Eric:** Each page below is in JSON-ready format. Drop straight into `lib/service-pages-oswego/data/[slug].json` (or wherever the existing data lives). Word counts are noted at the end of each section.

**For Dani:** Read each page once through. Flag anything that doesn't sound like you, anything clinically wrong, or anything that overpromises. We'll fix in Phase 1 before Phase 2 ships.

---

## Page 1: /solaria-co2-oswego

**Target keyword:** solaria co2 oswego (uncontested)
**Word count target:** 600+
**Approximate word count delivered:** ~720
...
```json
{
  ...
  "metaDescription": "Solaria CO2 laser resurfacing in Oswego, IL. The only practice in the western Chicago suburbs with this advanced InMode fractional CO2 technology. Free consultations.",
  ...
  "pricing": "Solaria CO2 pricing starts from $1,200 per session and varies by area treated and depth selected. Most clients see ideal results from a single session, though more aggressive resurfacing may benefit from a series. We give you exact pricing at your free consultation — no surprises, no upsells.",
  "faqs": [
    {
  ...
  "closingCta": "Book a free Solaria CO2 consultation. We'll assess your skin, talk through your goals, and give you a clear plan with exact pricing — no pressure, no surprises."
}
```

**Notes for Dani:**
- Hero copy positions Solaria as a "drove into the city to get this" technology — leaning into your geographic moat
- Compared Solaria vs. Morpheus8 directly in FAQ #2 because clients confuse them constantly
- Honesty thread woven throughout ("we'll be honest if something else would serve you better") — your brand voice
- Pricing is approximate ($1,200+) — confirm before publishing

---

## Page 2: /quantum-rf-oswego

**Target keyword:** quantum rf oswego (uncontested)
**Word count target:** 600+
**Approximate word count delivered:** ~710
...
```json
{
  ...
  "closingCta": "Book your free Quantum RF body contouring consultation. We'll talk through your goals, measure the areas you want to address, and give you a clear plan with exact pricing — no pressure to commit, ever."
}
```

**Notes for Dani:**
- Positioned against CoolSculpting (FAQ #1) — most clients will be coming from that comparison
- Honest about "not a weight loss treatment" (FAQ #6) — protects you from disappointed clients
- Pricing approximate ($800+/area) — confirm before publishing

---

## Page 3: /peptide-therapy-oswego

**Target keyword:** peptide therapy oswego (uncontested)
**Word count target:** 600+
**Approximate word count delivered:** ~680
...
```json
{
  ...
  "metaDescription": "Medical peptide therapy in Oswego, IL — NP-supervised protocols for recovery, performance, skin, sleep, and longevity. Free consultations available.",
  "h1": "Peptide Therapy in Oswego, IL",
  "valueProp": "Targeted peptide protocols supervised by a full-authority nurse practitioner — for recovery, performance, skin, sleep, and longevity.",
  "procedureType": "Injection",
  "bodyLocation": "Subcutaneous",
  "freshaServiceId": null,
  "heroContent": "Peptide therapy is one of the most promising frontiers in modern wellness medicine. Specific peptides can support recovery, immune function, skin quality, sleep, libido, lean muscle, and metabolic health — but only when prescribed correctly, sourced from reputable compounding pharmacies, and supervised by a qualified medical provider. At Hello Gorgeous, every peptide protocol is overseen by Ryan Kent, FNP-BC, with full medical authority. No internet-bought vials. No guesswork. Just real peptide therapy, done right.",
  "whyBullets": [
  ...
  "pricing": "Peptide therapy pricing varies significantly by the specific peptide(s) prescribed, dose, and duration. Most monthly protocols start from $250–$600 per month depending on what's prescribed and the supply length. Initial consultation and protocol design is included. We give you complete transparent pricing at your consultation before any commitment.",
  "faqs": [
    {
  ...
  "closingCta": "Curious if peptide therapy is right for you? Book a free, no-obligation consultation with our medical team. We'll listen, ask the right questions, and tell you honestly whether peptides fit your goals — or if something else would serve you better."
}
```

**Notes for Dani:**
- Heavy emphasis on "medical, supervised, pharmacy-sourced" — your real differentiator vs. internet peptide sellers
- FAQ #6 disambiguates peptides from GLP-1 (clients confuse these constantly)
- "Peptide therapy is a relationship, not a one-time sale" — your brand voice
- Pricing range is wide because peptide protocols vary so much — confirm whether you want this published or want to drive to consult

---

## Page 4: /nad-iv-oswego

**Target keyword:** nad iv oswego (uncontested)
**Word count target:** 600+
**Approximate word count delivered:** ~690
...
```json
{
  ...
  "metaDescription": "NAD+ IV therapy in Oswego, IL — supervised by a full-authority nurse practitioner. Cellular energy, mental clarity, longevity support. Free consultations.",
  "h1": "NAD+ IV Therapy in Oswego, IL",
  "valueProp": "The cellular-level wellness infusion the longevity world has been talking about — delivered medically, in-office, under NP supervision.",
  "procedureType": "Intravenous Therapy",
  "bodyLocation": "Systemic",
  "freshaServiceId": null,
  "heroContent": "NAD+ (nicotinamide adenine dinucleotide) is a coenzyme found in every cell of your body — essential for converting nutrients into the energy that powers everything from muscle function to brain clarity to DNA repair. NAD+ levels decline with age, stress, illness, and lifestyle factors, and IV infusion is the most direct way to restore them. Clients report mental clarity, sustained energy, improved sleep, faster recovery, and a general sense of feeling 'tuned up.' Done correctly, NAD+ therapy is one of the most powerful wellness tools available — but it should always be administered by qualified medical staff.",
  "whyBullets": [
  ...
  "closingCta": "Curious about NAD+ IV therapy? Book a free consultation with our medical team. We'll listen, talk through your goals, and give you a clear honest recommendation — including telling you if NAD+ isn't the right starting point for you."
}
```

**Notes for Dani:**
- Honest framing in FAQ #1 ("research continues to explore... most clinical claims today are based on subjective client experience") — protects you from FTC scrutiny on NAD+ claims, which is a real risk in this category right now
- Time commitment called out upfront ("plan to spend the morning or afternoon with us") — sets expectations
- "Not what's most expensive" in FAQ #6 — your brand voice
- Pricing: $400 starting from per infusion — confirm

---

## Voice review checklist for Dani

Read each page and check:

- [ ] Does this sound like me or like a generic med spa template?
- [ ] Are all clinical claims accurate?
- [ ] Are my real differentiators in there (Ryan FNP-BC, only-in-area, transparent pricing, honest consults)?
- [ ] Is the pricing realistic? Adjust any numbers I got wrong.
- [ ] Is anything overpromising or under-promising?
- [ ] Any client-facing words I'd never use?

If Phase 1 voice is approved, I'll do Phase 2 (the remaining 19 pages) with any adjustments you flag. Phase 2 will include the contested pages (Botox, Morpheus8 Burst, GLP-1, etc.) which need 1,000+ words and are higher-stakes for SEO competition.

---

## What Eric does with this

1. Take the JSON blocks above and drop them into the existing data structure (`lib/service-pages-oswego/data/[slug].json` or wherever the data lives — match the existing format)
2. The `pricing` field may need a new schema field if it doesn't exist yet — add it as an optional string field
3. The `inModeBadge` field for Solaria and Quantum signals which Verified Provider badge to display (Eric: pull badge images from your InMode rep if not already on the site)
4. The `freshaServiceId` is null for now — that gets filled in when Dani sends the Fresha ID CSV (separate FIX ticket)
5. Deploy and confirm the 4 uncontested pages render with the new content
6. Verify word counts are now 600+ on each page using the verification doc

---

*Phase 1 of 2. Phase 2 (remaining 19 pages) ships once Dani approves voice on these 4.*
