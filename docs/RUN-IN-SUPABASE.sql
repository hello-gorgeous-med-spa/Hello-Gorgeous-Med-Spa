-- ============================================================
-- COPY-PASTE INTO SUPABASE SQL EDITOR (run in order)
-- Dashboard → SQL Editor → New query → paste each block → Run
-- ============================================================

-- ---------------------------------------------------------------------------
-- BLOCK 1: ROOMS (for calendar room selection and room double-book prevention)
-- ---------------------------------------------------------------------------
-- Phase A: Rooms for smart scheduling (Zenoti/Aesthetic Record style)
...
-- ---------------------------------------------------------------------------
-- BLOCK 2: CONSULTATION SERVICE (for /book/consultation — choose Ryan or Danielle)
-- ---------------------------------------------------------------------------
-- Ensures "Free Consultation" exists so booking create API finds it by slug.
...
-- ---------------------------------------------------------------------------
-- BLOCK 3 (OPTIONAL): Chart audits + emergency response log (compliance)
-- Run only if you use Provider Governance → Chart Audits / Emergency Log.
-- Requires: providers and protocols tables (from provider governance phase 1).
-- ---------------------------------------------------------------------------
/*
