...
const nextConfig = {
  ...
  redirects: async () => [
    ...
    { source: "/bpc-157", destination: "/rx", permanent: true },
    { source: "/skin-101/find-your-peptide", destination: "/rx/request", permanent: true },
    { source: "/peptides/bpc-157", destination: "/rx", permanent: true },
    { source: "/peptides/ghk-cu-injectable", destination: "/rx", permanent: true },
    { source: "/peptides/copper-peptides", destination: "/rx", permanent: true },
    { source: "/peptides/cjc-1295", destination: "/rx", permanent: true },
    { source: "/peptides/cjc-1295-ipamorelin", destination: "/rx", permanent: true },
    { source: "/peptides/ipamorelin", destination: "/rx", permanent: true },
    { source: "/peptides/tb-500", destination: "/rx", permanent: true },
    { source: "/peptides/recovery-blend", destination: "/rx", permanent: true },
    { source: "/peptides/heal-blend", destination: "/rx", permanent: true },
    { source: "/peptides/k-glow", destination: "/rx", permanent: true },
    { source: "/peptides/aod-9604", destination: "/rx", permanent: true },
    { source: "/peptides/mots-c", destination: "/rx", permanent: true },
    { source: "/peptides/selank", destination: "/rx", permanent: true },
    { source: "/peptides/semax", destination: "/rx", permanent: true },
    { source: "/peptides/epithalon", destination: "/rx", permanent: true },
    { source: "/peptides/retatrutide", destination: "/rx", permanent: true },
    ...
    { source: "/rx/protocols/bpc157", destination: "/rx", permanent: true },
    { source: "/rx/protocols/sermorelin", destination: "/sermorelin", permanent: true },
    { source: "/rx/catalog/goal/:slug", destination: "/rx?goal=:slug", permanent: true },
