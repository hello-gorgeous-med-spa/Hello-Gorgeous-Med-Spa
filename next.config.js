...
const EMBEDDABLE_HTML_CSP = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://*.supabase.co https://js.stripe.com https://challenges.cloudflare.com https://*.withcherry.com https://files.withcherry.com https://assistloop.ai https://square.site https://*.square.site https://*.squareup.com https://app.squareup.com https://book.squareup.com",
  "worker-src 'self' blob:",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "img-src 'self' data: blob: https:",
  "font-src 'self' https://fonts.gstatic.com",
  "connect-src 'self' https://*.supabase.co https://api.openai.com https://api.stripe.com wss://*.supabase.co https://*.withcherry.com https://assistloop.ai https://*.assistloop.ai wss://*.assistloop.ai https://square.site https://*.square.site https://*.squareup.com https://app.squareup.com https://book.squareup.com https://connect.squareup.com",
  "frame-src 'self' https://js.stripe.com https://challenges.cloudflare.com https://www.alle.com https://*.alle.com https://*.withcherry.com https://pay.withcherry.com https://www.facebook.com https://www.youtube.com https://www.youtube-nocookie.com https://www.google.com https://assistloop.ai https://*.assistloop.ai https://square.site https://*.square.site https://*.squareup.com https://app.squareup.com https://book.squareup.com",
...
const nextConfig = {
  ...
  redirects: async () => [
    ...
    { source: "/rx/:path*", destination: "https://tryregenrx.com", permanent: true },
    ...
    { source: "/bpc-157", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/skin-101/find-your-peptide", destination: "https://tryregenrx.com/start", permanent: true },
    { source: "/peptides/bpc-157", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/ghk-cu-injectable", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/copper-peptides", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/cjc-1295", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/cjc-1295-ipamorelin", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/ipamorelin", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/tb-500", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/recovery-blend", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/heal-blend", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/k-glow", destination: "https://tryregenrx.com/learn/skincare", permanent: true },
    { source: "/peptides/aod-9604", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/mots-c", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/selank", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/semax", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/peptides/epithalon", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    ...
    { source: "/rx/protocols/bpc157", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    { source: "/rx/protocols/sermorelin", destination: "https://tryregenrx.com/learn/peptides", permanent: true },
    ...
    { source: "/images/regen/marketing/vial-recovery.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/images/regen/marketing/vial-full-recovery.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/images/regen/marketing/vial-cjc-ipa.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/images/regen/marketing/vial-tesamorelin-ipa.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/regen/marketing/kit/images/vial-lineup-glow.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/regen/marketing/kit/images/vial-lineup-studio.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/regen/marketing/kit/images/vial-bpc157-tb500.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/regen/marketing/kit/images/vial-cjc-ipamorelin.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/regen/marketing/kit/images/vial-tesamorelin-ipamorelin.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
    { source: "/regen/marketing/kit/images/vial-repair-quad.png", destination: "/images/regen/marketing/cell-peptide.png", permanent: true },
