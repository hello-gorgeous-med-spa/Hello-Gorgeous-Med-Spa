    ...
    <section className="py-6 md:py-8 px-4 md:px-6 bg-[#FDF7FA]">
      <div className="max-w-3xl mx-auto text-center min-w-0">
        <p className="text-[#FF2D8E] text-base md:text-lg leading-relaxed">
          ...
          ,{" "}
          <Link href="/prf-hair-restoration-oswego-il" className="text-[#FF2D8E] hover:text-[#FF2D8E] font-medium underline underline-offset-2">
            PRF Hair Restoration
          </Link>
          , and{" "}
          <Link href="/hormone-therapy-oswego-il" className="text-[#FF2D8E] hover:text-[#FF2D8E] font-medium underline underline-offset-2">
