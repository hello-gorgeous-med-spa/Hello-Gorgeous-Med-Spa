      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center rounded-full bg-[#FF2D8E] text-white text-xs font-bold">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#FF2D8E] hover:bg-black text-white text-sm font-medium rounded-lg transition-colors"
        >
