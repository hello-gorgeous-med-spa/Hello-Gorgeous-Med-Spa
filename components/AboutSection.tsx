    ...
    <Section className="relative bg-white">
      <FadeUp>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-[#E6007E] text-sm font-medium tracking-wide">OUR STORY</p>
          <h2 className="mt-4 text-3xl md:text-4xl font-serif font-bold text-[#111111]">
            About Hello Gorgeous
          </h2>
          <p className="mt-6 text-lg text-[#111111]/80 leading-relaxed">
          ...
          <Link
            href="/about"
            className="mt-6 inline-flex items-center gap-2 text-[#E6007E] font-semibold hover:text-[#B0005F] transition-colors"
          >
            Learn more about us
