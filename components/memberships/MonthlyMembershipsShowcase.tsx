              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    a: "a licensed Illinois clinician, is on site six days a week at our Oswego location — hormone, peptide, wellness, and Vitamin Bar memberships all run under NP supervision.",
                  },
                ].map((item) => (
                  <div key={item.q}>
