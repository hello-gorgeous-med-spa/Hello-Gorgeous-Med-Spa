      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-white" ref={containerRef}>
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <span className="text-[#E6007E] text-sm font-medium tracking-wide">TIKTOK</span>
            <h2 className="mt-2 text-2xl md:text-3xl font-serif font-bold text-[#E6007E]">
              Follow Us on TikTok
            </h2>
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 px-8 py-4 bg-black text-white font-semibold rounded-full hover:bg-[#E6007E] transition-colors"
            >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-6 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-[#E6007E] font-medium hover:underline"
          >
