...
const CASES: GalleryCase[] = [
  ...
  // ── InMode celebrity & clinical results ──────────────
  {
    type: "single-image",
    id: "celeb-inmode-1",
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "The technology celebrities trust — InMode results seen worldwide.",
    image: "/gallery/celeb-inmode-1/before-after.jpg",
    imageAlt: "InMode celebrity before and after result — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. The same InMode platform is available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
  ...
  },
  {
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "Skin transformation trusted by celebrities — InMode technology.",
    image: "/gallery/celeb-inmode-2/before-after.jpg",
    imageAlt: "InMode celebrity skin transformation before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
    type: "single-image",
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "The results celebrities rave about — now at Hello Gorgeous in Oswego.",
    image: "/gallery/celeb-inmode-3/before-after.jpg",
    imageAlt: "InMode celebrity result before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "Non-surgical transformation — InMode results trusted by celebrities worldwide.",
    image: "/gallery/celeb-inmode-4/before-after.jpg",
    imageAlt: "InMode non-surgical celebrity result before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "Hollywood-level results — now available in Oswego, IL.",
    image: "/gallery/celeb-inmode-5/before-after.jpg",
    imageAlt: "InMode Hollywood celebrity result before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "The same technology used by celebrities — now at Hello Gorgeous Oswego.",
    image: "/gallery/celeb-inmode-6/before-after.jpg",
    imageAlt: "InMode celebrity technology result before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "Visible improvement without surgery — InMode celebrity result.",
    image: "/gallery/celeb-inmode-7/before-after.jpg",
    imageAlt: "InMode celebrity visible improvement before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
    ...
    treatment: "InMode Technology — Celebrity Result",
    category: "Advanced Technology",
    tagline: "Real results from the world's most trusted aesthetic technology.",
    image: "/gallery/celeb-inmode-8/before-after.jpg",
    imageAlt: "InMode world trusted technology result before and after — Hello Gorgeous Med Spa Oswego IL",
    note: "InMode technology clinical result. Available at Hello Gorgeous Med Spa, Oswego, IL. Individual results vary.",
    serviceHref: "/trifecta-vip",
  },
  {
