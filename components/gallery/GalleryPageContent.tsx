...
/* ─────────────────────────────────────────────────────────────
   DATA — extend this array to add more cases
───────────────────────────────────────────────────────────── */
...
const CASES: GalleryCase[] = [
  {
    ...
    note:
      "Dermal filler placed for natural lip enhancement. Individual results vary. Performed at Hello Gorgeous Med Spa, Oswego, IL.",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg,#0a0a0a 0%,#2d1020 50%,#1a0a14 100%)",
        }}
      >
        {/* Radial overlays */}
        <div
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-white/70">
            Unfiltered, unedited results from our patients in Oswego, Naperville,
            Aurora &amp; surrounding communities. Every procedure performed by a
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              href={BOOKING_URL}
              className="inline-flex items-center rounded-full px-7 py-3 text-sm font-bold text-white transition hover:opacity-90"
              style={{
                background: `linear-gradient(125deg, ${BRAND.hot} 0%, ${BRAND.pink} 100%)`,
              }}
            >
              Book a Consultation
            </Link>
      ...
      <section className="mx-auto max-w-5xl px-4 py-10 md:py-14">
        ...
        <p className="mt-10 rounded-xl border border-black/10 bg-[#FFF0F7] p-4 text-[11px] leading-relaxed text-black/50">
          <strong className="text-black/70">Disclaimer:</strong> Photos and videos
          are from real patients of Hello Gorgeous Med Spa and are published with
          consent. Results are individual and cannot be guaranteed. All procedures
          are performed by licensed medical professionals. Consult with your
          provider to determine candidacy.
        </p>
      </section>
      ...
      >
        <div className="mx-auto max-w-2xl px-4 text-center">
          ...
          <p className="mt-3 text-base text-white/80">
            Book a free consultation at Hello Gorgeous Med Spa in Oswego, IL.
            Walk in as you are — leave looking and feeling gorgeous.
          </p>
